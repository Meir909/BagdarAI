    ...
    missions: [
      {
        ...
        options: [
          { id: "a", text: "Сразу переделать шаг 3 — убрать лишние поля", isCorrect: false },
          { id: "b", text: "Провести 5 быстрых интервью с пользователями, чтобы понять причину", isCorrect: true },
          { id: "c", text: "Посмотреть записи сессий в Hotjar/FullStory и найти паттерн", isCorrect: true },
          { id: "d", text: "Попросить менеджера подождать — нужно больше времени на анализ", isCorrect: false },
        ],
        xpReward: 25,
      },
      {
        ...
        options: [
          { id: "a", text: "Добавить inline-подсказки к каждому полю и сделать кнопку видимой на мобайле", isCorrect: true },
          { id: "b", text: "Разбить шаг 3 на 2 подшага — уменьшить когнитивную нагрузку", isCorrect: true },
          { id: "c", text: "Сделать часть полей необязательными и добавить прогресс-бар", isCorrect: true },
          { id: "d", text: "Настоять на удалении полей — пользовательский опыт важнее аналитики", isCorrect: false },
        ],
        xpReward: 30,
      },
      {
        ...
        options: [
          { id: "a", text: "Принять весь фидбек и обновить прототип — делаем все правки", isCorrect: false },
          { id: "b", text: "Исправить баг с кнопкой «Назад», вернуть поле «Город», остальное — в следующей итерации", isCorrect: true },
          { id: "c", text: "Приоритизировать фидбек по влиянию на пользователя: баг исправить, поле вернуть, лого — нет", isCorrect: true },
          { id: "d", text: "Отложить всё — нужно ещё одно тестирование", isCorrect: false },
        ],
        xpReward: 30,
      },
      {
        ...
        options: [
          { id: "a", text: "Запустить A/B тест на 3 дня — даже ограниченные данные лучше, чем ничего", isCorrect: true },
          { id: "b", text: "Выкатить новую версию полностью — у нас есть данные из тестов с пользователями", isCorrect: true },
          { id: "c", text: "Запустить только критические фиксы (баг + кнопка), отложить полный редизайн", isCorrect: true },
          { id: "d", text: "Отменить рекламу — нельзя запускать с непроверенным интерфейсом", isCorrect: false },
        ],
        xpReward: 35,
      },
      {
        ...
        options: [
          { id: "a", text: "Применить те же фиксы ко всем экранам — быстрый способ улучшить продукт", isCorrect: false },
          { id: "b", text: "Создать дизайн-систему — чтобы все изменения были консистентны и масштабируемы", isCorrect: true },
          { id: "c", text: "Провести UX-аудит всего продукта, приоритизировать проблемы, затем системно исправлять", isCorrect: true },
          { id: "d", text: "Нанять ещё дизайнеров — одному не справиться", isCorrect: false },
        ],
        xpReward: 30,
      },
    ],
